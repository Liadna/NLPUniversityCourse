...
def get_all_character_conversations(character, conversations):
    """
    Extract all the conversations of a given character. All conversations are with another character.
    :param character: Character of the conversations
    :param conversations: List of conversations
    :return: Dictionary of character and its conversations
    """
    char_conversations = {}
...
def classify_conversation(conversation, analyzer):
    """
    Perform a sensitivity analysis for a given conversation, by averaging the sentiment score of each sentence
    :param conversation: Conversation as a collection of sentences
    :param analyzer: Sentiment analyzer
    :return: Compound score of sentiment
    """
...
def classify(sentence, analyzer):
    """
    Perform a sensitivity analysis for a given sentence
...
def calculate_threshold(compound_value):
    """
    Determine the sentiment based on a threshold of 0.05, relatively to the compound value of the sentiment analysis.
    :param compound_value: The compound value of the sentiment analysis
